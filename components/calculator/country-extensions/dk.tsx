...
export default function DKCountryExtension({ country }: CountryCalculatorExtensionProps) {
  return (
    <NordicSimpleExtension
      country={country}
      description="This models ordinary Denmark employment salary for a full tax year using the calculator's current national assumptions."

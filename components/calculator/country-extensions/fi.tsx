...
export default function FICountryExtension({ country }: CountryCalculatorExtensionProps) {
  return (
    <NordicSimpleExtension
      country={country}
      description="This models ordinary Finland employment salary for a full tax year using the calculator's current national assumptions."

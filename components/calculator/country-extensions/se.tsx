...
export default function SECountryExtension({ country }: CountryCalculatorExtensionProps) {
  return (
    <NordicSimpleExtension
      country={country}
      description="This models ordinary Sweden employment salary for a full tax year using the calculator's current national assumptions."

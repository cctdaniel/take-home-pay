...
const popularStates = [
  "CA", "NY", "TX", "FL", "WA", "NJ", "MA", "IL", "PA", "GA", "NC", "CO", "AZ",
];
    ...
    <div className="space-y-4">
      ...
      <CalculatorFieldGrid columns={3}>
        <NumberField
          ...
          max={80}
          fallbackValue={30}
          description="Affects 401(k)/IRA/HSA catch-up limits"
        />
        <CountStepperField
          spanColumns={3}
          id="us-qualifying-children"
          label="Qualifying Children (CTC)"
          value={numberOfQualifyingChildren}
          onChange={onNumberOfQualifyingChildrenChange}
          max={10}
          description="$2,000 child tax credit each (simplified phase-out)"
        />
        <CountStepperField
          spanColumns={3}
          ...
          onChange={onNumberOfOtherDependentsChange}
          max={10}
          description="$500 credit for other dependents"
        />
      </CalculatorFieldGrid>
    </div>
  );

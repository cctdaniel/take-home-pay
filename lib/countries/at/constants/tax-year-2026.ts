...
export const AT_SOURCE_URLS = {
  ...
  source2:
    "https://www.bmf.gv.at/en/topics/taxation/Tax-rates-and-allowances.html",
  source3:
    "https://www.bmf.gv.at/en/topics/taxation/family-and-children/family-bonus-plus.html",
} as const;
...
export const AT_TAX_CONFIG = {
  ...
  taxCredit: 0,
  brackets: [
    { min: 0, max: 13_308, rate: 0 },
    { min: 13_308, max: 21_617, rate: 0.2 },
    { min: 21_617, max: 35_836, rate: 0.3 },
    { min: 35_836, max: 69_166, rate: 0.4 },
    { min: 69_166, max: 103_072, rate: 0.48 },
    { min: 103_072, max: 1_000_000, rate: 0.5 },
  ...
  assumptions: [
    ...
    "A user-entered commuter allowance is modeled as reducing the taxable wage base, and Family Bonus Plus is modeled as a capped child tax credit.",
    ...
    "13th/14th salary preferential taxation, exact commuter eligibility, single-earner credits, church contributions, in-kind benefits, and detailed monthly payroll caps are outside this annual salary model.",
  ],

...
// SUPPORTED COUNTRIES
// ============================================================================
// US first, then alphabetical by country name: Australia, Hong Kong, Netherlands, Portugal, Singapore, South Korea, Thailand
export const SUPPORTED_COUNTRIES: CountryCode[] = ["US", "AU", "CH", "HK", "ID", "NL", "PT", "SG", "KR", "TH"];

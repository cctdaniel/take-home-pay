...
// SUPPORTED COUNTRIES
// ============================================================================
// US first, then alphabetical by country name: Australia, Netherlands, Portugal, Singapore, South Korea, Thailand
export const SUPPORTED_COUNTRIES: CountryCode[] = ["US", "AU", "NL", "PT", "SG", "KR", "TH"];
